...
- **AIC_ERROR_CODE_MODEL_NOT_INITIALIZED**: Model must be initialized before calling this operation. Call `aic_model_initialize` first.
...
- **AIC_MODEL_TYPE_QUAIL_VF_STT_L16**:
...
- **AIC_ENHANCEMENT_PARAMETER_BYPASS**:
...
- **AIC_ENHANCEMENT_PARAMETER_ENHANCEMENT_LEVEL**:
...
- **AIC_ENHANCEMENT_PARAMETER_VOICE_GAIN**:
